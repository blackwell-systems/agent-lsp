...
func buildLanguageConfigs(fixtureBase string) []langConfig {
	return []langConfig{
		...
		},
		{
			...
			fixture:            filepath.Join(fixtureBase, "luau"),
			file:               filepath.Join(fixtureBase, "luau", "person.luau"),
			hoverLine:          4,
			hoverColumn:        7,
			definitionLine:     5,
			definitionColumn:   1,
			callSiteLine:       5,
			callSiteColumn:     16,
			callSiteFile:       filepath.Join(fixtureBase, "luau", "main.luau"),
			referenceLine:      4,
			referenceColumn:    7,
			completionLine:     5,
			completionColumn:   8,
			workspaceSymbol:    "Person",
			supportsFormatting: false,
			secondFile:         filepath.Join(fixtureBase, "luau", "greeter.luau"),
			symbolName:         "Person",
			highlightLine:      4,
			highlightColumn:    7,
			inlayHintEndLine:   18,
